...
import math
from demo.airfoil.vpm.vpmfunc import *
class Airfoil:
...
if __name__ == '__main__':
    ...
    plt.plot(airfoil.boundaryPoints_X, airfoil.boundaryPoints_Y,'-o', label='number of panel = '+ str(NUMBER_OF_PANEL), alpha=0.9)
    plt.legend()
    plt.title('panel model')
    plt.axis('equal')
    plt.savefig('panelModel')
