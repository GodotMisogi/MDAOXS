...
class MomentOfInertiaComp(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.declare_partials('I', 'h', method='cs')
...
class LocalStiffnessMatrixComp(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.declare_partials('K_local', 'I', method='cs')
...
class StatesComp(ImplicitComponent):
    ...
    def setup(self):
        ...
        self.declare_partials('d', 'K_local', method='cs')
        self.declare_partials('d', 'd', method='cs')
...
class DisplacementsComp(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.declare_partials('displacements', 'd', method='cs')
...
class ComplianceComp(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.declare_partials('compliance', 'displacements', method='cs')
...
class VolumeComp(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.declare_partials('volume', 'h', method='cs')
...
for num_elements in [10,100,200,500,1000,2000]:
    ...
    prob.setup()
    with timeblock('cs time cost with ' + str(num_elements)+ " elements: "):
